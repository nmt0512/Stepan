...
import com.mycompany.app.addsvForm;
...
public class qlsvForm extends javax.swing.JFrame {
    ...
    public void initializeData()
    {
        try
        {
            ...
            ResultSet records=stm.executeQuery("select * from students");
            while(records.next())
            {
                row=new Vector();
                row.add(records.getString("id"));
                row.add(records.getString("name"));
                row.add(records.getString("gender"));
                row.add(records.getString("email"));
                row.add(records.getString("phonenum"));
                row.add(records.getString("class"));
                row.add(records.getString("birthday"));
                data.add(row);
            }
            records.close();
            stm.close();
